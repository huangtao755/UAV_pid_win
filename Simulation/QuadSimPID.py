...
def test():
    ...
    # init controller
    pid = PidControl(kp_pos=np.array([0.3, 0.3, 0.3]),
                     ...
                     kp_att=np.array([4, 4, 4]),
                     ki_att=np.array([0., 0, 0]),
                     kd_att=np.array([0, 0, 0]),
                     kp_att_v=np.array([20, 20, 20]),
    ...
    plt.legend(fontsize=15, bbox_to_anchor=(1, 1.05))
    plt.subplot(4, 1, 4)
    plt.plot(t, ba[t, 0], label='f')
    plt.plot(t, ba[t, 1] / uav_para.uavInertia[0], label='t1')
    plt.plot(t, ba[t, 2] / uav_para.uavInertia[1], label='t2')
    plt.plot(t, ba[t, 3] / uav_para.uavInertia[2], label='t3')
